...
# Creating convulutional layer ( NN + Max pooling + Relu)
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples / batch_size) == 0:
            ...
            saver.save(session, './TND-Identifier-model')
...
#Prepare input data
classes = ['10','20','100','200','500','20000']
...
img_size = 128
num_channels = 3
train_path='../images/training_data'
...
# Creating 3 Convolutional layers
